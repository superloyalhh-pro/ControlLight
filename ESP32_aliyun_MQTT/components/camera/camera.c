...
//	s_state->sensor.set_hmirror(&s_state->sensor,1);
//	s_state->sensor.set_vflip(&s_state->sensor,1);
...
size_t camera_get_fb_size() {
	if (s_state == NULL) {
		return NULL;
	}
	return s_state->fb_size;
}
